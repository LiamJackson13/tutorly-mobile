...
const SignUpScreen = () => {
    ...
    const onSignUp = async () => {
        await handleSignUp(email, password, role, name);
    };
        ...
        >
            ...
            >
                <View style={styles.formContainer}>
                    ...
                    <Text style={styles.subtitle}>Join Tutorly
                        today</Text>
                    ...
                    {signUpError && (
                        <View style={styles.errorContainer}>
                            <Text
                                style={styles.errorText}>❌ {signUpError.message}</Text>
                        </View>
                    )}
                    ...
                    >
                        {isLoading ? (
                            ...
                            <Text style={styles.buttonText}>Sign
                                Up</Text>
                        )}
                    </TouchableOpacity>

                    <View style={styles.footer}>
                        <Text style={styles.footerText}>Already have
                            an account? </Text>
                        <TouchableOpacity
                            onPress={() => router.push("/(auth)/sign-in")}>
                            <Text style={styles.linkText}>Sign
                                In</Text>
                        </TouchableOpacity>
                    </View>
                </View>
